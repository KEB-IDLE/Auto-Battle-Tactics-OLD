public static class APIEndpoints
{
    ...
    public const string ChampionList = "/user/champion";
    public const string UnlockChampion = "/user/champion/unlock";

    public const string DeckList = "/user/deck";
    public const string SaveDeck = "/user/deck";
}
